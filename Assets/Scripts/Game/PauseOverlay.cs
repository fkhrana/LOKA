...
public class PauseOverlay : MonoBehaviour
{
    ...
    )
    {
        ...
        var effect =
            panel.GetComponent<EffectPanel>();
    ...
    private void CleanupStaleTransitions()
    {
        ...
        foreach (var t in oldTransitions)
        {
            ...
            Debug.LogWarning(
                "[PauseOverlay] Menemukan Transition instance lama (selesai), menghapus: "
                + t.gameObject.name
            );
